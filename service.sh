...
start_service() {
  ...
  launch_environment+=("FF_PYTHON_EVENT_OPTIMIZATIONS=${FF_PYTHON_EVENT_OPTIMIZATIONS:-1}")
  launch_environment+=("FF_EVALUATION_WINDOW_OPTIMIZATIONS=${FF_EVALUATION_WINDOW_OPTIMIZATIONS:-1}")
  launch_environment+=("FF_FACTOR_COMPUTE_CACHE=${FF_FACTOR_COMPUTE_CACHE:-1}")
  launch_environment+=("FF_FACTOR_CACHE_MB=${FF_FACTOR_CACHE_MB:-384}")
  launch_environment+=("FF_FACTOR_CACHE_DISK_MB=${FF_FACTOR_CACHE_DISK_MB:-0}")
